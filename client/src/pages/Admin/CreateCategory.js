...
const CreateCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(error);
      toast.error("Algo fallo al subir la nueva categoria");
    }
  };
  ...
  const getAllCategory = async () => {
    try {
      ...
      console.log(error);
      toast.error("Algo fallo al buscar las categorias");
    }
  };
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        toast.success(`${updatedName} se ha actualizado`);
        setSelected(null);
        setUpdatedName("");
        setVisible(false);
        getAllCategory();
  ...
  const handleDelete = async (pId) => {
    try {
      ...
      if (data.success) {
        toast.success(`la categoria fue borrada`);
